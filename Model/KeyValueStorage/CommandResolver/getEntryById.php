...
class getEntryById extends \LWmvc\Model\CommandResolver
{
    protected $command;
    ...
    {
        return new getEntryById($command);
    }
    ...
    public function resolve()
    {
        ...
        $entity = $queryHandler->loadEntityValuesById($this->command->getParameterByKey('id'));
        $entity->unsetDirty();
        $this->command->getResponse()->setDataByKey('Entry', $entity);
